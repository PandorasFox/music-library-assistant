...
use crate::{manual_review_modal, tag_editor, ActiveView};
...
impl App {
    ...
    pub(crate) fn start_manual_review_v3(&mut self, kind: types::ReviewKind) {
        ...
        self.view = ActiveView::ManualReviewV3 {
            data,
            review_kind: kind,
            current_group: 0,
    ...
    fn stage_stash_for_selected_file_v3(&mut self, gesture: &witness::ConfirmationGesture) {
        ...
        if let ActiveView::ManualReviewV3 {
            ref mut data, ..
        } = self.view
        {
    ...
    fn stage_mark_expected_duplicate_v3(&mut self, gesture: &witness::ConfirmationGesture) {
        let (group_idx, fingerprint_key, group_label) = {
            ...
            (current_group, key.clone(), group.label.clone())
        };
