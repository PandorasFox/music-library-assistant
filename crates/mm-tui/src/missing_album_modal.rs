...
impl MissingAlbumState {
    ...
    fn render_track_list(&mut self, f: &mut Frame, area: Rect) {
        ...
        let block = crate::helpers::focused_block(" Tracks ", is_focused);
...
/// Display wrapper for tracks in a Missing Album artist group (V3 StandardList).
...
/// Render the Missing Album Singles V3 resolution view.
///
