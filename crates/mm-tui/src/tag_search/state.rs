...
use crate::widgets::standard_list::{ListEntry, StandardListConfig, StandardListState};
...
impl TagSearchState {
    ...
    fn focused_input_mut(&mut self) -> Option<&mut crate::widgets::TextInputState> {
    ...
    pub fn handle_text_input(&mut self, action: &crate::input::InputAction) -> bool {
