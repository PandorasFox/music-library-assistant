//! StandardList: unified list state machine.
//!
...
use crate::wizard::{WizardItem, WizardState};
use crate::wizard_pane::WizardPaneState;
...
impl StandardListState {
    ...
    pub fn recompute_scroll(&mut self, item_count: usize) {
...
mod tests {
    ...
    use crate::wizard::{WizardOffer, WizardItem};
