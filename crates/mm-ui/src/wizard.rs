...
mod tests {
    ...
    fn pane_offer() -> WizardOffer {
        WizardOffer::Pane {
            title: "Title".into(),
            content: vec![RichBlock::Paragraph(vec![RichSpan::plain("detail")])],
        }
    }
    ...
    fn both_offer() -> WizardOffer {
        WizardOffer::Both {
            ...
            pane_content: vec![RichBlock::Paragraph(vec![RichSpan::plain("full detail")])],
        }
    }
