...
pub fn router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/tx/apply-va-overrides", post(api::transactions::apply_va_overrides))
        .route("/tx/edit-genre-vocabulary", post(api::transactions::edit_genre_vocabulary))
        .route("/tx/promote-genres", post(api::transactions::promote_genres))
        .route("/tx/promote-genres-for-inodes", post(api::transactions::promote_genres_for_inodes))
