...
pub use mm_meta::signals::data::{
    ...
    SameRecordingDifferentReleaseData, SameRecordingDifferentReleaseEntry,
...
#[derive(Debug, Clone)]
pub struct SameRecordingDifferentReleaseSignal {
    pub key: String, // MB recording MBID
    /// Serialized as bincode BLOB.
    pub data: SameRecordingDifferentReleaseData,
}
...
impl_content_hash!(SameRecordingDifferentReleaseSignal => blob(data));
