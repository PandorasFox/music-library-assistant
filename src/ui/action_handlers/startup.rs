...
impl HandleAction for crate::ui::startup::IntakeConfirmationAction {
    fn handle(self, app: &mut App, gesture: Option<&witness::ConfirmationGesture>) {
        use crate::ui::startup::IntakeConfirmationAction;
        ...
        let is_inbox_source = matches!(
            app.view,
            ActiveView::IntakeConfirmation(ref s) if s.source == crate::ui::startup::IntakeSource::Inbox
        );
                ...
                if mutations.is_empty() {
                    ...
                    if open_txn {
                        ...
                        app.start_transaction_review_with_phase(
                            crate::ui::transaction_review::PostCommitPhase::ContentAnalysis,
                        );
                    }
                }
            }
