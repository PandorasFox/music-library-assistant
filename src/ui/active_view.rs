...
pub(crate) enum ActiveView {
    ...
    EmbedAlbumArtResolution(embed_album_art_modal::AlbumArtReviewState),
...
impl ActiveView {
    ...
    pub(crate) fn header_suffix(&self) -> Option<&'static str> {
        match self {
            ...
            Self::EmbedAlbumArtResolution(_) => Some("Album Art Review"),
...
pub(crate) enum ViewAction {
    ...
    EmbedAlbumArtResolution(embed_album_art_modal::AlbumArtReviewAction),
