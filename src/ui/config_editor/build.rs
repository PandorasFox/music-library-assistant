        ...
        ConfigGroup {
            ...
            fields: vec![
                ...
                field("Auto-enrich on match", "Auto-trigger MB enrichment when AcoustID matches arrive",
                    ...
                    source_for(ops.external_matching.auto_enrich_on_match == defaults.external_matching.auto_enrich_on_match, "auto-enrich-on-match"),
                    false,
                ...
                field("MB cache TTL (days)", "Days before re-fetching MusicBrainz cache entries",
                    ...
                    source_for(ops.external_matching.mb_cache_ttl_days == defaults.external_matching.mb_cache_ttl_days, "mb-cache-ttl-days"),
                    false,
                    |v, c| { if let ConfigValue::UintU32(n) = v { c.opinions.external_matching.mb_cache_ttl_days = *n; } }),
                field("MB max candidates", "Max MB recording candidates to enrich per track",
                    ConfigValue::UintU32(ops.external_matching.mb_max_candidates),
                    source_for(ops.external_matching.mb_max_candidates == defaults.external_matching.mb_max_candidates, "mb-max-candidates"),
                    false,
