...
pub fn render(f: &mut Frame, area: Rect, state: &mut ExternalMatchesViewState) {
    ...
    let snap = RenderSnapshot {
        ...
        fetch_progress: state.fetch_progress.as_ref(),
...
struct RenderSnapshot<'a> {
    has_api_key: bool,
    fetch_active: bool,
    fetch_progress: Option<&'a crate::witch::external_fetch::FetchProgress>,
    cached_data: Option<&'a crate::meta::views::ExternalMatchesData>,
}
